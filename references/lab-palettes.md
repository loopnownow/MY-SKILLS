...
**Owner:** `ly-figures`. Hex must match `D:\0Grok\0RAD\modules\config\style.py` `FIG_PALETTES` and `console.html` `PALETTES`.

Generic journal palettes (ggsci NPG / Okabe–Ito / Morandi role maps) stay in `bundles/radiology-figure/references/color-systems.md`. This file is the **lab console five-set** used by the 0RAD pipeline.
