...
- **v4 (CHG-20260913-001):** **10 coarse** stage buckets + **55 fine ids** (session-pick). `session_mount: ask-each-run` — multi-select fine ids under relevant coarse; do not auto-load all. Menu is not `mounts: []`.
