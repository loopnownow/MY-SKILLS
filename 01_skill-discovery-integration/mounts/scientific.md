...
[总览](README.md) · [Scientific · 备份](scientific.md)

来源 [K-Dense-AI/scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills) · 扫 `1e5eeff`
...
| v4 细 ID（PROPOSED） | `paper-lookup` · `hypothesis-generation` · `statistical-power` · `venue-templates` · `exploratory-data-analysis` · `pydicom` · `scikit-survival` · `scientific-critical-thinking` |
