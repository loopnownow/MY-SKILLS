...
- `https://github.com/K-Dense-AI/scientific-agent-skills` (`PROPOSED`, backup). Preset map: `sources/scientific-agent-skills.proposed.yaml` (scanned `1e5eeff`). 12 mapped (5 partial) / 2 empty (`02-radiomics-habitat`, `05-humanize`).
