...
Skill Harvest is the **maintenance and evolution system** for `00`–`06` domain skills. It does four jobs:
...
The default destination remains an existing `00`–`06` skill. `skill-harvest` itself is the only maintenance skill.
