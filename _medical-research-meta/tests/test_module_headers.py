...
class ModuleHeaderTests(unittest.TestCase):
    ...
    def test_mounts_board(self):
        ...
        self.assertIn("7 个空挂", oc)
        self.assertIn("23 / 30", oc)
        self.assertIn("02-imaging-qc", oc)
        self.assertIn("03-lit-fulltext", oc)
        self.assertIn("05-write-venue", oc)
        self.assertIn("06-review-response", oc)
        self.assertIn("pubmed-search", oc)
        self.assertIn("clinical-trial-protocol-skill", oc)
        self.assertIn("radiomics-pathomics-fusion-agent", oc)
        self.assertIn("FreedomIntelligence/OpenClaw-Medical-Skills", oc)
        self.assertNotIn("ocms-literature", oc)
        ...
        self.assertIn("id: 03-lit-fulltext", nat_y)
        self.assertIn("id: 06-review-response", nat_y)


        self.assertIn("scan_sha: \"b1f9b6e\"", oc_y)
        self.assertIn("id: 03-design-protocol", oc_y)
        self.assertIn("clinical-trial-protocol-skill", oc_y)
        self.assertIn("id: 02-radiomics-habitat", oc_y)
        self.assertIn("05-humanize", oc_y)
        self.assertIn("clinical-reports not included", oc_y)
