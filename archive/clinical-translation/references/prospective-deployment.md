...
- This section is the deployment-lifecycle half of the **FUTURE-AI** framework (Fairness,
  ...
  Robustness/Explainability evidence, and `../../../core/05_manuscript/bundles/manuscript-core/references/merged/radiology-reporting/guideline-router.md` for how the
