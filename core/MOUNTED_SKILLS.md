...
| Id | Layer | Role |
|---|---|---|
| `02-xlsx` | 02 | Excel/CSV automation |
| `02-imaging-qc` | 02 | Imaging preprocessing QC docs |
| `02-radiomics-habitat` | 02 | Radiomics/habitat preparation |
| `02-impute` | 02 | Missing/outlier processing |
| `02-generic-docs` | 02 | Generic imaging/data notes |
| `03-literature` | 03 | Literature / sources / journals / datasets |
| `03-design` | 03 | Study design / validation / blueprints |
| `03-frontier` | 03 | Frontier themes / idea-to-question |
| `04-stats-generic` | 04 | Generic statistical encyclopaedia |
| `04-figure-engine` | 04 | Figure generation (moved out of 05) |
| `05-writing-generic` | 05 | Generic writing / reporting / citation / journal house style |
| `06-review-generic` | 06 | Generic prereview / response machinery |
