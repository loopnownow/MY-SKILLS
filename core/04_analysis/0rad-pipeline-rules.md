...
**Owner:** `04_analysis`. Implementation lives in `D:\0Grok\0RAD\modules` (and copies under each project). Workspace / file layout → `02_data-processing/0rad-workspace.md`. Coding conventions → mounted `02-radiomics-habitat` + `archive/code-refactoring`.
