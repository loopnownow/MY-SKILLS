...
Lab 0RAD implements this as `VAL_MODE` = `refit` | `apply_formula` | `lock_threshold` (features never re-selected). Definitions: `04_analysis/references/0rad-pipeline-rules.md`.
