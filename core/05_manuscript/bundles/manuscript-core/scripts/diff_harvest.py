...
writing, de-AI, figures -> 05_manuscript). This does NOT live under
...
Every run appends one row to data/diff-evidence-log.csv so evidence
accumulates across editing sessions before the next full corpus re-harvest.

Usage
-----
    python3 diff_harvest.py \\
        --phrase-bank ../references/corpus/corpus-phrase-bank.md \\
        --forbidden ../references/de-ai/forbidden-phrases.md \\
