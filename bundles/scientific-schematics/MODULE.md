...
- Drawing methodology flowcharts for study design (CONSORT, PRISMA) — **except** Ying Li lab SCI **Figure 1** enrollment/analysis flows, which use `ly-figures/bundles/strobe-flowchart`
