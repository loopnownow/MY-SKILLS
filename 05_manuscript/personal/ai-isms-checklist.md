...
| Word | What to do |
|---|---|
| significant / significantly | Decorative density: replace some with specifics. Do **not** cut statistical *significantly* when it is p-value language (`04_analysis/personal/stats-checklist.md`). |
