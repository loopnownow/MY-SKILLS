...
labels **Training Cohort / Test Cohort**, plus **Validation Cohort** only when
Methods states an external cohort (`Aitor-format.md`). Only an other-hospital
cohort is a validation set. Never `Development set`.
