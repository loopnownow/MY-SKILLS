...
- 来源只写在批注**正文前缀**（文首）：这条判断从哪一层来，不是标信封。
  ...
  - 例：`[A:personal]` · `[B:06-review-peer]` · `[Nature:nature-reviewer]` · `[Scientific:scientific-critical-thinking]` · `[MedSci:self-review]` · `[AIPOCH:peer-review]` · `[ARS:academic-paper-reviewer]` · `[03-lit-search]`（个人/粗 ID 任务）
  - 挂载 + 个人都成立 → **双标**，例：`[Nature:nature-reviewer] [A:personal]` / `[Scientific:scientific-critical-thinking] [A:personal]`
- **强制：** 本轮挂了 ARS / MedSci / Scientific / OpenClaw / AIPOCH / Nature（或非个人 B 包）时，凡发现/门控/清单条目来自该挂载，前缀**必须**含 **skill 级**标签（`[Nature:nature-reviewer]` 这类），不能只写源。禁止因为走了个人八章信封就把全部写成 `[A:personal]`。
