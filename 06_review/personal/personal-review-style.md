...
- 来源只写在批注**正文前缀**（文首）：这条判断从哪一层来，不是标信封。
  - 例：`[A:personal]` · `[06-review-peer]` · `[B:…]` · `[ARS:academic-paper-reviewer]` · `[MedSci:self-review]` · `[Scientific:peer-review]` · `[OpenClaw:peer-review]` · `[AIPOCH:peer-review]` · `[Nature:…]` · `[03-lit-search]`
  - 挂载 + 个人都成立 → **双标**，例：`[Scientific:peer-review] [A:personal]` / `[OpenClaw:peer-review] [A:personal]` / `[AIPOCH:peer-review] [A:personal]` / `[Nature:…] [A:personal]`
- **强制：** 本轮挂了 ARS / MedSci / Scientific / OpenClaw / AIPOCH / Nature（或非个人 B 包）时，凡发现/门控/清单条目来自该包，前缀**必须**含 `[ARS:…]` / `[MedSci:…]` / `[Scientific:…]` / `[OpenClaw:…]` / `[AIPOCH:…]` / `[Nature:…]` / `[B:…]`。禁止因为走了个人八章信封就把全部写成 `[A:personal]`。
- 无挂载时不得出现 `[MedSci:]` / `[ARS:]` / `[Scientific:]` / `[OpenClaw:]` / `[AIPOCH:]` / `[Nature:]` 空壳前缀。纯实验室改句（语法、Aitor 标点）只标 `[A:personal]`。
